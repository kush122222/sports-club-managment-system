...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('admin1', 'admin1', 'admin1', 'Tennis Club Manager');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1529336794', 'Roger Federer', 'Male', '3362013747', 'Roger@gmail.com', '1968-04-13', '2018-06-18');
INSERT INTO `users` VALUES ('1529336795', 'Djokovic', 'Male', '3362013741', 'Novak@gmail.com', '1998-12-12', '2020-06-10');
INSERT INTO `users` VALUES ('1529336796', 'Rafael Nadal', 'Male', '3362013742', 'Nadal@gmail.com', '1998-12-12', '2020-06-10');
INSERT INTO `users` VALUES ('1529336797', 'alcazar', 'Male', '3362013743', 'alcazar@gmail.com', '1998-12-12', '2020-06-10');
INSERT INTO `users` VALUES ('1529336798', 'tsitsipas', 'Male', '3362013744', 'tsitsipas@gmail.com', '1998-12-12', '2020-06-10');
INSERT INTO `users` VALUES ('1529336799', 'Nick Krygos', 'Male', '3362013745', 'Nick@gmail.com', '1998-12-12', '2020-06-10');
...
INSERT INTO `health_status` VALUES (3, NULL, NULL, NULL, NULL, NULL, '1529336795');
INSERT INTO `health_status` VALUES (4, NULL, NULL, NULL, NULL, NULL, '1529336795');
INSERT INTO `health_status` VALUES (5, NULL, NULL, NULL, NULL, NULL, '1529336795');
...
-- Records of plan
-- ----------------------------
INSERT INTO `plan` VALUES ('FOQKJF', 'Tennis Plan', 'A monthly subscription that unlocks the members access to the football Plan and coach support on chat.', '1', 1000, 'yes');
INSERT INTO `plan` VALUES ('COQKJC', 'Fitness Plan', 'A monthly subscription that unlocks the members access to the Cricket Plan and coach support on chat.', '1', 1500, 'yes');
INSERT INTO `plan` VALUES ('BOQKJB', 'Core Plan', 'A monthly subscription that unlocks the members access to the Badminton Plan and coach support on chat.', '1', 800, 'yes');
...
-- ----------------------------
DROP TABLE IF EXISTS `Tennis_timetable`;
CREATE TABLE `Tennis_timetable` (
